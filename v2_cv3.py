...
# Kinect position
# Distance from boundry line of court 
Dz = 750
# x postion kinect from mapping origin
Dx = 6700
# y ie height of kinect
Dy = 1500
# Tilt angle to be obtained from kinect
# TODO: tilt angle
...
def convert(x, y, z_real):
	...
	# kcr stands for kinect centered real
	x_kcr = (320-x)*z_real/f_x
	y_kcr = (240-y)*z_real/f_y
	# mor stands for mapping origin real
	x_mor = x_kcr + Dx
	y_mor = y_kcr + Dy
	z_mor = z_real - Dz
...
if __name__ == "__main__":
	...
	while flag is False:
		...
		depth1 = depth.copy()
		img, contours, _ = cv2.findContours(depth1, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
		l = len(contours)
		for i in range(0, l):
